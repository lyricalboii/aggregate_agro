...
!(function (a) {
  ...
  a("#preloader").fadeOut("normall", function () {
    ...
    t.on("scroll", function () {
      ...
      e <= 50
        ? (a("header").removeClass("scrollHeader").addClass("fixedHeader"),
          o.attr("src", "img/logos/logo-white.png"))
    ...
    t.on("resize", function (e) {
      clearTimeout(o),
        (o = setTimeout(function () {
          991 < t.width()
            ? a(".dashboard-left-sidebar .dashboard-menu").show()
            : a(".dashboard-left-sidebar .dashboard-menu").hide();
        }, 250));
    }),
    a(".collapse-sm").on("click", function () {
      a(".dashboard-left-sidebar .dashboard-menu").slideToggle(),
        a(this).hasClass("current")
          ? a(this).removeClass("current")
          : (a(this).removeClass("current"), a(this).addClass("current"));
    }),
    ...
    t.on("load", function () {
      t.stellar(),
        0 !== a(".price-range").length &&
          a(".price-range").ionRangeSlider({
            type: "double",
            grid: !0,
            min: 0,
            max: 20000,
