...
<!-- Mirrored from jobboard.websitelayout.net/job-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Sep 2022 12:48:05 GMT -->
<head>
                            ...
                            <div class="col-lg-6">
                                <div class="page-title-list">
                                    <ol class="breadcrumb d-inline-block mb-0">
                                        ...
                                        <li class="breadcrumb-item d-inline-block active"><a href="#!" class="text-primary">Job Details</a></li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pe-lg-1-6 pe-xl-1-9">
                            <div class="row align-items-center mb-2-2 pb-2-2 border-bottom border-color-extra-light-gray">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <div class="job-details-logo">
                                                <img src="img/content/job-01.jpg" alt="..." class="border-radius-10">
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="row">
                                        <div class="col-12">
                                            <a href="#!" class="butn mb-3 w-100 text-center">Apply Job</a>
                                        </div>
                                        <div class="col-12">
                                            <a href="#!" class="butn w-100 text-center">Shortlist</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-12 mb-2-2">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        <li class="mb-3"><i class="fas fa-check text-primary me-2 vertical-align-middle"></i>2+ years retail revel in in a management capacity.</li>
                                        <li class="mb-3"><i class="fas fa-check text-primary me-2 vertical-align-middle"></i>Bachelor’s diploma or equal experience.</li>
                                        <li class="mb-3"><i class="fas fa-check text-primary me-2 vertical-align-middle"></i>Ability to efficiently teach and inspire income associates.</li>
                                        <li class="mb-3"><i class="fas fa-check text-primary me-2 vertical-align-middle"></i>Willingness to expose management and steerage from the floor.</li>
                                        <li><i class="fas fa-check text-primary me-2 vertical-align-middle"></i>Familiarity with style tendencies and styles.</li>
                                    </ul>
                                </div>
                                <div class="col-lg-12 mb-2-2">
                                    <h5 class="mb-3">Other Benefits :</h5>
                                    <ul class="list-unstyled mb-0">
                                        <li class="mb-3"><i class="fas fa-check text-primary me-2 vertical-align-middle"></i>Health and life insurance.</li>
                                        <li class="mb-3"><i class="fas fa-check text-primary me-2 vertical-align-middle"></i>Lunch and Snacks</li>
                                        <li class="mb-3"><i class="fas fa-check text-primary me-2 vertical-align-middle"></i>2 days of weekend.</li>
                                        <li><i class="fas fa-check text-primary me-2 vertical-align-middle"></i>2 annual performanc bonuses.</li>
                                    </ul>
                                </div>
                                <div class="col-lg-12">
                                    <h5 class="mb-4">Share This Post :</h5>
                                    <ul class="social-icons-list">
                                        <li><a class="facebook" href="#!"><i class="fab fa-facebook-f me-2"></i>Facebook</a></li>
                                        <li><a class="twitter" href="#!"><i class="fab fa-twitter me-2"></i>Twitter</a></li>
                                        <li><a class="youtube" href="#!"><i class="fab fa-youtube me-2"></i>Youtube</a></li>
                                        <li><a class="linkedin" href="#!"><i class="fab fa-linkedin-in me-2"></i>Linkedin</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card border-color-extra-light-gray border-radius-10">
                                    <div class="card-body p-4">
                                        ...
                                        <ul class="list-style5">
                                            <li><span>Published</span> Nov 6, 2021</li>
                                            <li><span>Vacancy</span> 08</li>
                                            <li><span>Status</span> Full-time</li>
                                            <li><span>Experience</span> 5 year(s)</li>
                                            <li><span>Location</span> Canada</li>
                                            <li><span>Salary</span> $25K</li>
                                            <li><span>Gender</span> Any</li>
                                            <li><span>Deadline</span> Nov 15, 2021</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card border-color-extra-light-gray border-radius-10">
                                    <div class="card-body p-4">
                                        ...
                                        <ul class="list-style5">
                                            ...
                                            <li><span>Website</span> www.info.com</li>
                                ...
                                <div class="d-lg-flex align-items-center mb-4 mb-lg-0">
                                    <div class="flex-shrink-0">
                                        <div class="job-company-logo radius-10">
                                            <img src="img/content/job-02.jpg" alt="..." class="border-radius-10">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 ms-lg-4">
                                        <h4 class="h5"><a href="job-details.html">Sr. Project Manager</a></h4>
                                        <span class="me-2"><i class="ti-briefcase pe-2 text-secondary"></i>Factory & Industry</span>
                                        <span class="me-2"><i class="ti-location-pin pe-2 text-secondary"></i>California</span>
                                        <span class="me-2"><i class="ti-time pe-2 text-secondary"></i>12 Hour Ago</span>
                                        <span class="me-2"><i class="far fa-money-bill-alt pe-2 text-secondary"></i>$15K</span>
                                        <span class="company-info radius-10">Full Time</span>
                                    </div>
                                </div>
                                <a href="job-details.html" class="butn butn-md">Apply Job</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 mb-1-9">
                        <div class="p-1-6 border border-color-extra-light-gray bg-white border-radius-10">
                            <div class="d-lg-flex justify-content-between align-items-center text-center text-lg-start">
                                <div class="d-lg-flex align-items-center mb-4 mb-lg-0">
                                    <div class="flex-shrink-0">
                                        <div class="job-company-logo radius-10">
                                            <img src="img/content/job-03.jpg" alt="..." class="border-radius-10">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 ms-lg-4">
                                        <h4 class="h5"><a href="job-details.html">UI / UX Designer</a></h4>
                                        <span class="me-2"><i class="ti-briefcase pe-2 text-secondary"></i>IT</span>
                                        <span class="me-2"><i class="ti-location-pin pe-2 text-secondary"></i>New York</span>
                                        <span class="me-2"><i class="ti-time pe-2 text-secondary"></i>14 Hour Ago</span>
                                        <span class="me-2"><i class="far fa-money-bill-alt pe-2 text-secondary"></i>$18K</span>
                                        <span class="company-info radius-10">Part Time</span>
                                    </div>
                                </div>
                                <a href="job-details.html" class="butn butn-md">Apply Job</a>
                            </div>
                        ...
                        <div class="p-1-6 border border-color-extra-light-gray bg-white border-radius-10">
                            <div class="d-lg-flex justify-content-between align-items-center text-center text-lg-start">
                                <div class="d-lg-flex align-items-center mb-4 mb-lg-0">
                                    <div class="flex-shrink-0">
                                        <div class="job-company-logo radius-10">
                                            <img src="img/content/job-04.jpg" alt="..." class="border-radius-10">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 ms-lg-4">
                                        <h4 class="h5"><a href="job-details.html">Software Engineer</a></h4>
                                        <span class="me-2"><i class="ti-briefcase pe-2 text-secondary"></i>Construction</span>
                                        <span class="me-2"><i class="ti-location-pin pe-2 text-secondary"></i>London</span>
                                        <span class="me-2"><i class="ti-time pe-2 text-secondary"></i>18 Hour Ago</span>
                                        <span class="me-2"><i class="far fa-money-bill-alt pe-2 text-secondary"></i>$20K</span>
                                        <span class="company-info radius-10">Full Time</span>
                                    </div>
                                </div>
                                <a href="job-details.html" class="butn butn-md">Apply Job</a>
                        ...
                        <div class="p-1-6 border border-color-extra-light-gray bg-white border-radius-10">
                            <div class="d-lg-flex justify-content-between align-items-center text-center text-lg-start">
                                <div class="d-lg-flex align-items-center mb-4 mb-lg-0">
                                    <div class="flex-shrink-0">
                                        <div class="job-company-logo radius-10">
                                            <img src="img/content/job-05.jpg" alt="..." class="border-radius-10">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 ms-lg-4">
                                        <h4 class="h5"><a href="job-details.html">Content Writing</a></h4>
                                        <span class="me-2"><i class="ti-briefcase pe-2 text-secondary"></i>IT</span>
                                        <span class="me-2"><i class="ti-location-pin pe-2 text-secondary"></i>Uk</span>
                                        <span class="me-2"><i class="ti-time pe-2 text-secondary"></i>20 Hour Ago</span>
                                        <span class="me-2"><i class="far fa-money-bill-alt pe-2 text-secondary"></i>$40K</span>
                                        <span class="company-info radius-10">Part Time</span>
                                    </div>
                                </div>
                                <a href="job-details.html" class="butn butn-md">Apply Job</a>
