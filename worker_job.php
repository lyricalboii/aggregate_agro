                        ...
                        <div class="sidebar">
                            ...
                            <div class="widget">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="temporary" id="temporary">
...
?>
    ...
    <!-- all js include end -->
    <script>
    const checkbox = document.getElementById('full-time')
    ...
    checkbox.addEventListener('change', (event) => {
        if (event.currentTarget.checked) {
            ...
            console.log('fulltime unchecked')
        }
    })

    $(document).on('change', '#full-time', function (e) {
            e.preventDefault();
